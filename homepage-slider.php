<?php  
/*
* Template Name: Alamak Homepage Slider
* Description: Alamak Homepage Slider
*/
get_header(); ?>
                    ...
                    <div class="col-md-6"> 
                    	<div class="slider-content clearfix">
                            ...
                            <div class="title-caption">
                                <h4><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'slider_cap_top' )) { echo wp_kses_post ( ot_get_option( 'slider_cap_top' )); 
								} else { echo "We are creative team";} ?></h4>
                            </div><!--/.title-caption-->
        	...
        	<div class="container">
            	<div class="title-content clearfix">
                	<div class="title-inner">
                    	<h3><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'portfolio_title' )) { echo esc_attr( ot_get_option( 'portfolio_title' )); } else { echo "Our Recent Works";} ?></h3>
                        <p><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'portfolio_small' )) { echo esc_attr( ot_get_option( 'portfolio_small' ) ); } else { echo "What we've done so far";} ?></p>
                    </div><!--/.title-inner-->
                </div><!--/.title-content-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 port-item" id="post-<?php the_ID(); ?>">
                        <div class="port-inner white-bg clearfix">
							...
							?>
                            <a class="box-40 hovers bwWrapper" data-rel="prettyPhoto" href="<?php echo esc_url( $image_url[0]);  ?>" >
		...
		<section class="bg-dark bg1">
        	...
        	<div class="container align-center">
                <h3 class="slogan"><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'para_quote_text' )) { echo esc_attr( ot_get_option( 'para_quote_text' )); }?></h3>
                <div class="slogan-divider"><span class="line-left"></span><span class="fa fa-quote-left"></span><span class="line-right"></span></div>
                <h4 class="author-slogan"><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'para_quote_author' )) { echo esc_attr( ot_get_option( 'para_quote_author' )); }?></h4>
            </div><!--/.container-->
        </section><!--/.bg-dark-->
        ...
        <section id="about" class="clearfix content">
        	<div class="container">
            	<div class="title-content clearfix">
                	<div class="title-inner">
                    	<h3><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'about_title' )) { echo esc_attr ( ot_get_option( 'about_title' )); } else { echo "Story About Us";} ?></h3>
                        <p><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'about_small' )) { echo esc_attr ( ot_get_option( 'about_small' )); } else { echo "The Things you Should Know";} ?></p>
                    </div><!--/.title-inner-->
                </div><!--/.title-content-->
        ...
        <section id="services" class="clearfix content">
        	<div class="container">
            	<div class="title-content clearfix">
                	<div class="title-inner">
                    	<h3><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'services_title' )) { echo esc_attr ( ot_get_option( 'services_title' )); } else { echo "Our Services";} ?></h3>
                        <p><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'services_small' )) { echo esc_attr ( ot_get_option( 'services_small' )); } else { echo "What we really can provide";} ?></p>
                    </div><!--/.title-inner-->
                </div><!--/.title-content-->
        ...
        <section class="bg-dark twitter-feed clearfix">
        	...
        	<div class="container align-center">
                ...
                <a href="<?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'twitter_feed_link' )) { echo esc_url ( ot_get_option( 'twitter_feed_link' )); } ?>" class="tweet-follow">
					<?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'twitter_feed_text' )) { echo esc_attr ( ot_get_option( 'twitter_feed_text' )); } else { echo "Follow Us";} ?>
                </a>
            </div><!--/.container-->
        </section><!--/.bg-dark-->
        <!--TWITTER SECTION END-->
        ...
        <section id="contact" class="clearfix content">
        	<div class="container">
            	<div class="title-content clearfix">
                	<div class="title-inner">
                    	<h3><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'contact_title' )) { echo esc_attr ( ot_get_option( 'contact_title') ); } else { echo "Our Contact";} ?></h3>
                        <p><?php if  ( function_exists( 'ot_get_option' ) && ot_get_option( 'contact_small' )) { echo esc_attr ( ot_get_option( 'contact_small' )); } else { echo "Start communicate with us";} ?></p>
                    </div><!--/.title-inner-->
                </div><!--/.title-content-->
